...
DOWNLOAD_URL="https://github.com/brewhaase/xbmc-frodo/raw/master/Frodo_Install/Downloads/"
...
DIALOG_WIDTH=70
SCRIPT_TITLE="XBMC installation script v$SCRIPT_VERSION for Ubuntu 12.10 by Bram van Oploo updated by Brew"
